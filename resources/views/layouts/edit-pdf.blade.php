<body>
        ...
        <div class="col-lg-12">
          ...
          <div class="card" id="contentToPrint">
            <div class="card-body">
              ...
              <input type="hidden" name="id_fbn" value="{{$id}}">
              <!-- General Form Elements -->
              <form method="POST" action="{{route('editexportPdf')}}" enctype="multipart/form-data" role="form">
              {{ csrf_field() }}
              {{ method_field('PUT') }}
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="project_number"  value="{{ $fbn->project_number }}" >
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name="background"  >{{ $fbn->background }}</textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control txt-role" name="id_pic" required>
                      ...
                      @if($fbn->id_pic == $pc->id)
                      <option value="{{ $pc->id }}" selected>{{ $pc->nama }}</option>
                      @else
                ...
                <div class="table-responsive tabletiming" id="tabletiming">
                  <table class="table" id="table">
                    ...
                    <tbody ">
                      @foreach(\App\Models\Timing::where('id_fbn',$id)->get() as $t)
                ...
                <div class="table-responsive tablecustom">
                  <table class="table table-bordered" id="customTable">
                    <thead>
                      <tr>
                        <th></th>
                        @foreach(\App\Models\Kolom::where('id_fbn',$id)->get() as $k)
                    ...
                    <tbody>
                      @foreach(\App\Models\Baris::where('id_fbn',$id)->get() as $b)
  ...
  <script>
    ...
    //ID FBN
    var id_fbn = $("input[name=id_fbn]").val();
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            $.ajax({
              type: "get",
              url: '../refresh-timing-detail-edit/' + id_fbn,
              data: {
                "_token": "{{ csrf_token() }}",
              },
  ...
  <script>
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            $.ajax({
              type: "get",
              url: '../refresh-custom-table-edit/' + id_fbn,
              data: {
                "_token": "{{ csrf_token() }}",
              },
              success: function(data) {
    ...
    $(".btn-add-data").click(function(e) {
      ...
      $.ajax({
        type: "get",
        url: '../refresh-baris-kolom-edit/' + id_fbn,
        data: {
          "_token": "{{ csrf_token() }}",
        },
        success: function(data) {
